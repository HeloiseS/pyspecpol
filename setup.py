...
PACKAGENAME = metadata.get('package_name', 'pyspecpol')
DESCRIPTION = metadata.get('description', 'Utilities for spectropolarimetry analysis and data reduction')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: pyspecpol requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
